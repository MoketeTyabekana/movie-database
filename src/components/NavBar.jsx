    ...
    <>
      <nav className="bg-white-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border-b-2 border-gray-400 border-opacity-10 w-screen fixed top-0 left-0 shadow-md z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-5">
          {/* Company logo with icon and h1 element for the company name */}
          ...
          <button
            ...
            onClick={toggleMenu} // An on click method that handles the click event of the button function.
          >
            <svg
              className="w-5 h-5"
              aria-hidden="true"
      ...
      {/* Main section that uses Outlet to display the page that is responsible for the nav bar link that has been clicked by the user. */}
      <main>
        <Outlet />
      </main>
      <FooterContainer />
