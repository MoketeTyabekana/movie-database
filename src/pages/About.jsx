...
function About() {
  return (
    <div className="min-h-screen bg-custom-gradient from-red-950 to-red-900 p-6 md:p-12">
    <div className="container w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-6">
          ...
          <h2 className="text-xl md:text-2xl text-red-200 mb-6">Frontend Developer</h2>
